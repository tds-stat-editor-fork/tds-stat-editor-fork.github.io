...
class Viewer {
    ...
    #loadTable() {
        ...
        if (this.tower.name == 'Farm' || this.tower.name == 'Trapper' || this.tower.name == 'Military Base' || this.tower.name == 'Mercenary Base' || this.tower.name == 'Elf Camp' || this.tower.name == 'Firework Technician' || this.tower.name == 'Biologist' || this.tower.name == 'Mecha Base') this.propertyViewer.disabled.push('Uptime');
