export default {
  Accelerator: {
    Default: {
      ...
      Defaults: {
        ...
        Cooldown: 0.2,
        Price: 7500,
        Attributes: { ChargeTime: 6.5, LaserCooldown: 2.5, Overcharge: 9000},
        Range: 20,
        Damage: 12,
      },
    },
      ...
      Upgrades: [
        ...
        },
        {
          ...
          Stats: {
            ...
            Damage: 6,
            Cooldown: 0.65,
            Attributes: {MinStun: 0.08, MaxStun: 0.08, DefenseMelt: 10},
          },
  ...
  "Frost Blaster": {
    Default: {
      Upgrades: [
        {
          ...
          Stats: {
            Detections: { Hidden: true },
            Attributes: {ChillDuration: 0.6, FreezeTime: 0.6},
            Cooldown: 0.5,
            Range: 15,
          },
          Title: "Endurance",
        ...
        },
        {
          ...
          Stats: {
            Damage: 5,
            Attributes: {MaxHits: 4, ChillPercent: 75, MaxChill: 75, DefenseMelt: 15},
          },
          Title: "Piercing Cold",
          Cost: 1350,
        },
      ...
      Defaults: {
        Detections: { Flying: false, Hidden: false, Lead: true },
        Attributes: { DefenseMelt: 0, MaxDefenseMelt: 33, MaxHits: 3, FreezeTime: 0.45, ChillPercent: 50, MaxChill: 50, ChillDuration: 0.45, TickRate: 0.25},
        Price: 850,
        Range: 12,
        Cooldown: 0.6,
        Damage: 3,
  ...
  Shotgunner: {
    Default: {
      ...
      Defaults: {
        Detections: { Flying: false, Hidden: false, Lead: false },
        Attributes: { Spread: 100, ShotSize: 6, Pierce: 2.5},
        Price: 800,
        Range: 7.5,
        Cooldown: 1,
        Damage: 2,
