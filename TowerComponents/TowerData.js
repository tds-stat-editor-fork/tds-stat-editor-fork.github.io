export default {
  ...
  "Frost Blaster": {
    Default: {
      ...
      Defaults: {
        Detections: { Flying: false, Hidden: false, Lead: true },
        Attributes: { DefenseMelt: 0, MaxDefenseMelt: 33, FreezeTime: 0.5, MaxHits: 3, ChillPercent: 30, MaxChill: 30, ChillDuration: 2, TickRate: 0.25},
        Price: 850,
        Limit: 10,
        Range: 12,
        Cooldown: 0.85,
      ...
      Upgrades: [
        ...
        },
        {
          Stats: {
            ...
            Attributes: {BurnTime: 4, Ice: true, IceTick: 0.25},
            Damage: 4,
          },
          Image: 15332518503,
          Title: "Cold Humor",
      ...
      Upgrades: [
        ...
        },
        {
          ...
          Stats: {
            ...
            Attributes: { UnitToSend: "Tank", AirstrikeDamage: 75, AirstrikeBombs: 6, AirstrikeRadius: 8, AirstrikeCooldown: 45, AirstrikeCost: 500},
          },
          Title: "Tank",
          Cost: 8000,
        },
  ...
  Rocketeer: {
    Default: {
      ...
      Defaults: {
        Attributes: { Deadzone: 10, ExplosionRadius: 3, RocketCount: 1, SpreadAngle: 0, Accuracy: 1},
        Detections: { Flying: false, Hidden: false, Lead: true },
        Range: 22,
        Price: 1500,
        Limit: 8,
